...
<template>
  <main class="flex flex-col gap-4 lg:gap-8">
    <div
      class="shrink-0 border p-4 pb-16 lg:p-8 lg:pb-20 rounded-xl border-border bg-center bg-cover relative"
    >
      ...
      <div
        class="mt-16 flex flex-col lg:flex-row justify-between items-center relative z-10"
      >
        <!-- left -->
        <div class="flex lg:flex-col w-full lg:w-fit justify-between relative">
          ...
          <div class="flex flex-col lg:flex-row">
            <div
              ...
              :class="
                semifinals[0]?.winning_team === 'teamA'
                  ? 'border-lime-400'
                  : 'border-brand/30'
              "
            >
              <img
                :src="semifinals[0]?.teamA?.club?.logo"
                :alt="semifinals[0]?.teamA?.club?.name"
              ...
              >
                <UAvatar
                  :src="semifinals[0]?.teamA?.players[0]?.profileImg"
                ...
                <UAvatar
                  :src="semifinals[0]?.teamA?.players[1]?.profileImg"
          ...
          <div class="flex flex-col lg:flex-row relative">
            <div
              ...
              :class="
                semifinals[0]?.winning_team === 'teamB'
                  ? 'border-lime-400'
                  : 'border-brand/30'
              "
            >
              <img
                :src="semifinals[0]?.teamB?.club?.logo"
                :alt="semifinals[0]?.teamA?.club?.name"
              ...
              >
                <UAvatar
                  :src="semifinals[0]?.teamB?.players[0]?.profileImg"
                  :alt="semifinals[0]?.team?.players[0]?.name"
                  class="w-full h-full [&_img]:object-top grayscale-100 size-8 shrink-0 bg-white"
                />
                ...
                <UAvatar
                  :src="semifinals[0]?.teamB?.players[1]?.profileImg"
                  :alt="semifinals[0]?.team?.players[1]?.name"
                  class="w-full h-full [&_img]:object-top grayscale-100 size-8 shrink-0 bg-white"
                />
              </div>
            ...
            <!-- line -->
            <div
              class="w-16 h-32 2xl:h-40 border border-l-0 border-t-0 hidden lg:block lg:rounded-br-2xl"
              :class="
                semifinals[0]?.winning_team === 'teamB'
                  ? 'border-lime-400'
                  : 'border-brand/30'
          ...
          <h2
            class="w-28 lg:w-32 mt-8 hidden lg:block 2xl:w-40 text-center text-brand text-lg absolute -bottom-12"
          >
            Semifinal
          </h2>
        </div>
        ...
        <div class="lg:hidden px-14 w-full">
          <div class="flex">
            <div
              class="w-1/2 h-18 border border-lime-400 border-t-0 border-r-0 rounded-bl-md"
            />
            <div
              class="w-1/2 h-18 border border-brand/30 border-l-lime-400 border-t-0 border-l-0 rounded-br-md"
            />
          </div>
        </div>
        ...
        <!-- middle -->
        <div
          class="flex-1 w-full lg:w-auto flex items-center justify-center flex-col lg:flex-row"
        >
          ...
          <div
            class="size-16 rounded-full shrink-0 border border-brand/30 flex items-center justify-center"
          >
            ⚽ 0
          </div>
          ...
          <div class="relative">
            <div
              class="size-32 2xl:size-52 shrink-0 rounded-full border border-lime-400 flex items-center justify-center bg-brand/10 text-4xl text-brand p-4"
            >
              <img
                :src="semifinals[2]?.teamA?.club?.logo"
                :alt="semifinals[2]?.teamA?.club?.name"
                class="w-full h-full object-cover rounded-full"
              />
            </div>
          ...
          <!-- Semi Finalist -->
          <div
            class="relative w-full lg:w-auto h-full flex justify-between lg:flex-col gap-32 lg:gap-20"
          >
            <div
              class="size-28 lg:size-36 2xl:size-40 shrink-0 rounded-full border border-brand/90 flex items-center justify-center bg-brand/10 text-4xl text-brand opacity-40"
            >
              <img
                :src="semifinals[1]?.teamB?.club?.logo"
                :alt="semifinals[1]?.teamA?.club?.name"
                class="w-full h-full object-cover rounded-full p-4"
              />
            </div>

            <div
              class="size-28 lg:size-36 2xl:size-40 shrink-0 rounded-full border border-lime-400 flex items-center justify-center bg-brand/10 text-4xl text-brand -ml-4 lg:ml-0"
            >
              <img
                :src="semifinals[0]?.teamB?.club?.logo"
                :alt="semifinals[0]?.teamA?.club?.name"
            ...
            >
              <div class="relative w-full h-full">
                <!-- score -->
                <div
                  class="absolute w-1/2 lg:w-full top-1/2 left-1/2 -translate-1/2 flex justify-center z-20"
                >
                  <div
                  ...
                  >
                    <h3
                      class="font-semibold"
                      :class="
                        semifinals[2]?.scoreB > semifinals[2]?.scoreA
                          ? 'text-lime-400'
                          : ''
                      "
                    >
                      {{ semifinals[2]?.scoreB ? semifinals[2].scoreB : "-" }}
                    </h3>
                    <span>:</span>
                    <h3
                      class="font-semibold"
                      :class="
                        semifinals[2]?.scoreA > semifinals[2]?.scoreB
                          ? 'text-lime-400'
                          : ''
                      "
                    >
                      {{ semifinals[2]?.scoreA ? semifinals[2].scoreA : "-" }}
                    </h3>
                  </div>
                </div>
                ...
                <!-- left -->
                <div
                  class="absolute w-1/2 h-[0.5px] left-0 top-1/2 -translate-y-1/2 bg-brand/90 lg:bg-lime-400"
                />
                <!-- right -->
                <div
                  class="absolute w-1/2 h-[0.5px] right-0 top-1/2 -translate-y-1/2 bg-lime-400 lg:bg-brand/90"
                />

                <!-- top -->
                <div
                  class="absolute h-1/2 w-[0.5px] left-1/2 top-0 -translate-x-1/2 bg-lime-400 lg:bg-brand/40"
                />

                <!-- bottom -->
                <div
                  class="absolute h-1/2 w-[0.5px] left-1/2 bottom-0 -translate-x-1/2 bg-brand/90 lg:bg-lime-400"
                />
              </div>
            </div>
        ...
        <div class="lg:hidden px-14 w-full">
          <div class="flex">
            <div
              class="w-1/2 h-18 rounded-tl-lg border border-brand/30 border-b-0 border-r-0"
            ></div>
            <div
              class="w-1/2 h-18 rounded-tr-lg border border-brand/90 border-b-0 border-l-0"
            ></div>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex flex-col lg:flex-row opacity-40">
            ...
            <div
              ...
              :class="
                semifinals[1]?.winning_team === 'teamA'
                  ? 'border-lime-400'
                  : 'border-brand/30'
              "
            />
            ...
            >
              <img
                :src="semifinals[1]?.teamA?.club?.logo"
                :alt="semifinals[1]?.teamA?.club?.name"
              ...
              >
                <UAvatar
                  :src="semifinals[1]?.teamA?.players[0]?.profileImg"
                ...
                <UAvatar
                  :src="semifinals[1]?.teamA?.players[1]?.profileImg"
          ...
          <div class="flex flex-col lg:flex-row">
            <!-- line -->
            <div
              class="hidden lg:block w-16 h-32 2xl:h-40 border border-r-0 border-t-0 lg:rounded-bl-2xl"
              :class="
                semifinals[1]?.winning_team === 'teamB'
                  ? 'border-brand/90'
                  : 'border-brand/30'
              "
            />
            ...
            >
              <img
                :src="semifinals[1]?.teamB?.club?.logo"
                :alt="semifinals[1]?.teamB?.club?.name"
                class="w-full h-full object-cover rounded-full p-4"
              />
              ...
              >
                <UAvatar
                  :src="semifinals[1]?.teamB?.players[0]?.profileImg"
                  :alt="semifinals[1]?.team?.players[0]?.name"
                  class="w-full h-full grayscale-100 size-8 shrink-0"
                />

                <div class="w-full h-px"></div>
                <UAvatar
                  :src="semifinals[1]?.teamB?.players[1]?.profileImg"
                  :alt="semifinals[1]?.team?.players[1]?.name"
                  class="w-full h-full grayscale-100 size-8 shrink-0"
                />
              </div>
