    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              class="size-28 lg:size-36 2xl:size-40 shrink-0 rounded-full border border-brand/50 flex items-center justify-center bg-brand/10 text-4xl text-brand"
            >
              ?
            </div>
            ...
            >
              <div class="relative w-full h-full">
                  ...
                  >
                    <div class="flex items-center gap-2">
                      ...
                      <h3
                        ...
                        :class="
                          semifinals[1]?.scoreA > semifinals[1]?.scoreB
                            ? 'text-lime-400'
                            : ''
                        "
                      >
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <img
                        :src="semifinals[0]?.teamB?.club?.logo"
                        :alt="semifinals[0]?.teamB?.club?.name"
                ...
                <!-- left -->
                <div
                  class="absolute w-1/2 h-[0.5px] left-0 top-1/2 -translate-y-1/2 bg-brand/40"
                />
                <!-- right -->
                <div
                  class="absolute w-1/2 h-[0.5px] right-0 top-1/2 -translate-y-1/2 bg-brand/40"
                />

                <!-- top -->
                <div
                  class="absolute h-1/2 w-[0.5px] left-1/2 top-0 -translate-x-1/2 bg-brand/40"
                />

                <!-- bottom -->
                <div
                  class="absolute h-1/2 w-[0.5px] left-1/2 bottom-0 -translate-x-1/2 bg-brand/40"
                />
              </div>
            </div>
