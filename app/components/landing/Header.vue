...
<template>
  <header class="flex justify-between items-start">
    <div class="flex items-center gap-4">
      <img src="/assets/images/fc.jpg" alt="fc"
        class="size-12 lg:size-16 rounded-lg border border-border object-cover" />

      <div>
        <h1 class="text-lg lg:text-3xl text-brand font-semibold">
          FC26 Tournament
        </h1>
        <span>Ongoing</span>
      </div>
    ...
    <div>
      <USelect v-model="app.matchType" value-key="value" :items="[
        { label: 'Pre Season', value: 'PRESEASON' },
        { label: 'Semi Final', value: 'SEMIFINAL' },
        // { label: 'Final', value: 'FINAL' },
      ]" class="w-32 md:w-48 py-2" :ui="{
